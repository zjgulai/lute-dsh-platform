window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/t4wefan/code/github/deepseek-harness-desktop/deepseek-harness/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".l5nhXW_card{flex-direction:column;display:flex}.l5nhXW_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.l5nhXW_row[data-expandable]{cursor:pointer}.l5nhXW_card[data-state=running] .l5nhXW_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite l5nhXW_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes l5nhXW_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.l5nhXW_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.l5nhXW_chevron{color:var(--dsw-alias-label-secondary)}.l5nhXW_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.l5nhXW_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.l5nhXW_row:hover .l5nhXW_iconIdle{opacity:0}.l5nhXW_row:hover .l5nhXW_chevronHover{opacity:1}.l5nhXW_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.l5nhXW_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.l5nhXW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.l5nhXW_errorSummary{color:var(--dsw-alias-state-error-primary)}.l5nhXW_bodyWrap{flex-direction:column;display:flex}.l5nhXW_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.l5nhXW_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.l5nhXW_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.l5nhXW_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.l5nhXW_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.l5nhXW_instructions::-webkit-scrollbar-track{margin:6px 0}.l5nhXW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.l5nhXW_card:hover .l5nhXW_inspectButton,.l5nhXW_inspectButton:focus-visible{opacity:1}.l5nhXW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.l5nhXW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.l5nhXW_card[data-state=running] .l5nhXW_row:after{animation:none;display:none}.l5nhXW_iconIdle,.l5nhXW_chevronHover,.l5nhXW_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"bodyWrap": "l5nhXW_bodyWrap",
			"card": "l5nhXW_card",
			"chevron": "l5nhXW_chevron",
			"chevronHover": "l5nhXW_chevronHover",
			"dsh-skill-row-sweep": "l5nhXW_dsh-skill-row-sweep",
			"errorSummary": "l5nhXW_errorSummary",
			"iconIdle": "l5nhXW_iconIdle",
			"inspectButton": "l5nhXW_inspectButton",
			"instructions": "l5nhXW_instructions",
			"instructionsCard": "l5nhXW_instructionsCard",
			"instructionsHeader": "l5nhXW_instructionsHeader",
			"leading": "l5nhXW_leading",
			"row": "l5nhXW_row",
			"separator": "l5nhXW_separator",
			"summary": "l5nhXW_summary",
			"title": "l5nhXW_title",
			"visuallyHidden": "l5nhXW_visuallyHidden"
		};
		//#endregion
