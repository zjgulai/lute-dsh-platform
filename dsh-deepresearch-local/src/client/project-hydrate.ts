...
const emptyProgress = { running: 0, waiting: 0, scouts: [] as ResearchProject['progress']['scouts'] }

/** Normalize one wire project after Remote parse. */
export function hydrateResearchProject(project: ResearchProject): ResearchProject {
