...
export const deepResearchDomainSpec = defineDomain({ name: 'deepresearch', version: 3, tables: { projects: domainTable<import('./types.ts').ResearchId, import('./types.ts').ResearchProject>(researchProjectSchema) } })
