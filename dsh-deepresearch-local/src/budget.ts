...
export const PLAN_DEPTH_LIMITS: Record<ResearchDepth, { maxQuestions: number; maxCriteriaPerQuestion: number }> = {
...
export function planLimits(depth: ResearchDepth, config: { maxQuestions: number; maxCriteriaPerQuestion: number }): { maxQuestions: number; maxCriteriaPerQuestion: number } {
 ...
 */
export function inferResearchPlanDepth(question: string, goal = ''): ResearchDepth {
 ...
 */
export function resolveSubmittedDepth(requested: ResearchDepth, question: string, goal = ''): ResearchDepth {
...
export function planResearchBudget(criterionCount: number, used?: { searchesUsed: number; fetchesUsed: number }): ResearchBudget {
...
export function countCriteria(questions: ReadonlyArray<{ criteria: readonly unknown[] }>): number {
...
export function assertPlanFitsDepth(
  depth: ResearchDepth,
  questions: ReadonlyArray<{ criteria: readonly unknown[] }>,
  config: { maxQuestions: number; maxCriteriaPerQuestion: number },
): void {
...
export function isOversizedPlanError(error: unknown): boolean {
...
export function budgetForProject(project: Pick<ResearchProject, 'questions' | 'budget'>): ResearchBudget {
