/**
 * Standalone tsdown config for the New App launcher.
 *
 * Uses the repo's shared client-bundle preset (build/tsdown.client.ts):
 * node-half lib/ (the health route) plus the browser bundle lib/client.js
...
export default clientBundle('dsh-newapp-local', ['src/index.ts'], {
  libExternal: [
