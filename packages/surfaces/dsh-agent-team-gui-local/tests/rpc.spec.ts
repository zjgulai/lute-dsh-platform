...
/**
 * Run one endpoint with a typed success value; the handler itself is ConnectionRpcResult<unknown>.
 * 类型来自 dsh-client-connection（与 src/rpc.ts 同源）——apiproxy 已在运行时 rc.1 中移除。
 */
